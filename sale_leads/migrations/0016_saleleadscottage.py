...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sale_leads', '0015_remove_saleleadscommercialoffice_kitchen_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='SaleLeadsCottage',
            fields=[
                ...
                ('interiors', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Empty', 'Empty / Unfurnished'), ('Semi', 'Semi Furnished'), ('Fully', 'Fully Furnished')], max_length=30, null=True, verbose_name='Interiors')),
                ('kitchen', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Empty', 'Empty'), ('Shelves', 'Shelves'), ('Modular', 'Modular')], max_length=30, null=True, verbose_name='Kitchen')),
